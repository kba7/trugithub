...
//    @Bind(R.id.tv_signup) TextView signupText;
    ...
    private PasswordView passwordText;
...
//    private MenuItem loginItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        loginButton = finder.find(R.id.btn_login);
...
//        passwordText.setUseStrikeThrough(true);
